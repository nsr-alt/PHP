...
<body>
    ...
    <section>
        ...
        <p>Seu computador travou? A internet não colabora? Chame o Tech SOS! Suporte técnico rápido, confiável e sem complicações. Soluções tecnológicas na palma da sua mão.</p>

        <div class="img">
            <img src="img/Sobre/computer.jpg" alt="computador 1">  
            
            <img src="img/Sobre/download (1).jpg" alt="computador 2">

            <img src="img/Sobre/images.jpg" alt="computador 3">
        </div>
